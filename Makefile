...
LDFLAGS = -ldwmapi -lopengl32 -lSDL2-static -luser32 -lgdi32 -lshell32 -lwinmm -lsetupapi -lole32 -ladvapi32 -limm32 -lversion -loleaut32 -Wl,-nodefaultlib:msvcrt -Wl,-subsystem:windows -Wl,-entry:mainCRTStartup -gcodeview -fuse-ld=lld -Xlinker /debug -Xlinker /pdb:main.pdb -target x86_64-pc-windows-msvc
LDFLAGS_DEBUG= -g
...
backup:
	...
	upx -9 ./bin/$(TARGET)
	git add -A
	git commit -m 'Acceleration and nbodies'
