...
LDFLAGS_DEBUG= -g
EMCCFLAGS = --preload-file inc/font.bmp@inc/font.bmp --preload-file inc/mandelbrot.atl@inc/mandelbrot.atl -O3 -s WASM=1 -s USE_WEBGL2=1 -s USE_SDL=2 -s MAX_WEBGL_VERSION=3 -s MIN_WEBGL_VERSION=2 --shell-file shell.html
TARGET = Atlas.exe
HTML = index.html
JS = $(HTML:.html=.js)
WASM = $(HTML:.html=.wasm)
